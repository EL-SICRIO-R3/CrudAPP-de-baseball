            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost:8080/programacion-web/CrudAPP-de-baseball/Ampayers/">Manejadores</a>
                        </li>
                         <li class="nav-item">
    ...
    <div class="container" style="margin-top: 10px;">
        <form class="row g-3" action="insertar.php?id=<?php echo $idEquipo ?>" method="POST" id="formulario">
            ...
            <div class="col-md-5">
                ...
                <input type="text" class="form-control" id="inputLogo" name="Logo" required="true">
            </div>
